...
st.set_page_config(page_title="ORACLE V16 Ω COSMOS", layout="wide")
...
question = st.text_area("Pose ta question à ORACLE", height=150)
col1, col2 = st.columns(2)
with col1:
...
uploaded = st.file_uploader("Importer un document", type=["txt","pdf","docx","csv"])
if uploaded:
